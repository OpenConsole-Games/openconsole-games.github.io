...
(function () {
    function receiveMessage(event) {
        ...
        switch(message.type) {
          case "SetUnityGame":
            var gameLoc = message.loc;
            if (!gameLoc.startsWith(window.location.hostname)) {
              gameLoc = message.corsProxy + gameLoc;
            }
            UnityLoader.instantiate("gameContainer", gameLoc, {onProgress: UnityProgress});
            break;
        }
    }
